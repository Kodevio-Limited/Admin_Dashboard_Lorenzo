...
const initialProperties: Property[] = [
  {
    ...
    clientName: clients[0].name || clients[0].firstName || '',
    servicePlan: 'Premium',
  ...
  },
  {
    ...
    clientName: clients[1].name || clients[1].firstName || '',
    servicePlan: 'Premium',
  ...
  },
  {
    ...
    clientName: clients[2].name || clients[2].firstName || '',
  ...
  },
  {
    ...
    clientName: clients[3].name || clients[3].firstName || '',
    servicePlan: 'Premium',
  ...
  },
  {
    ...
    clientName: clients[4].name || clients[4].firstName || '',
    servicePlan: 'Standard',
    assignedFieldRep: 'Shane Gordon',
  ...
  },
  {
    ...
    clientName: clients[5].name || clients[5].firstName || '',
    servicePlan: 'Basic',
    assignedFieldRep: 'Kareem James',
  ...
  },
  {
    ...
    clientName: clients[6].name || clients[6].firstName || '',
    servicePlan: 'Standard',
    assignedFieldRep: 'Tanya Samuels',
  ...
  },
  {
    ...
    clientName: clients[7].name || clients[7].firstName || '',
    servicePlan: 'Basic',
    assignedFieldRep: 'Shane Gordon',
